 ...
 * BUILD: 20260522-design — טלפון, לוגו, תמונת רכב
 */

const LANDING_BUILD = "20260522-reviews";
...
const CONFIG = {
  ...
  reviews: [
    ...
    },
    {
      name: "יוסי מ.",
      rating: 5,
      text: "קבלתי את המחיר הכי נמוך שהציעו לי. אחלה שירות, אני אחדש אצלהם גם שנה הבאה — ממליץ!"
    },
    {
      name: "שירה א.",
      rating: 5,
      text: "השוויתי כמה הצעות במקום אחד, חסכתי זמן וכסף. נציג מקצועי וסבלני, ממליצה לכל מי שמחפש ביטוח רכב."
    }
  ],
  ...
  insuranceTypes: [
    { value: "comprehensive", label: "ביטוח מקיף" },
    { value: "third_party", label: "ביטוח צד ג" },
    { value: "third_party_mandatory", label: "ביטוח צד ג וחובה" },
    { value: "comprehensive_mandatory", label: "ביטוח מקיף וחובה" }
  ],

  submitButtonLabel: "קבל הצעה בקליק",
  ...
  leadIngest: {
    ...
    secret: "aria1990",
    campaignId: "cmp_car_landing",
    campaignLabel: "ביטוח רכב — דף נחיתה",
...
async function sendLeadToCRM(leadData) {
  ...
  const payload = {
    ...
    insurance_type_label: leadData.insuranceTypeLabel,
